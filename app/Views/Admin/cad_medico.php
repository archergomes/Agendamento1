            ...
            <div class="container mx-auto px-4 py-8">
                ...
                <div class="form-container">
                    <div class="card-header">
                        <h3><i class="fas fa-user-md text-blue-500 mr-2"></i>Dados do Médico</h3>
                    </div>
                    <form id="doctor-form" onsubmit="saveDoctor(event)">
                        <div class="form-grid">
                            <div class="form-group form-full-width">
                                <label for="doctor-name">Nome Completo <span class="required">*</span></label>
                                <input type="text" id="doctor-name" class="form-input" required placeholder="Nome completo">
                                <div class="form-error" id="name-error">Por favor, insira um nome válido</div>
                            </div>

                            <div class="form-group">
                                <label for="doctor-phone">Telefone <span class="required">*</span></label>
                                <input type="tel" id="doctor-phone" class="form-input" required placeholder="+258 84 1234567">
                            ...
                            <div class="form-group">
                                <label for="doctor-bi">BI <span class="required">*</span></label>
                                <input type="text" id="doctor-bi" class="form-input" required placeholder="Número do BI">
                            ...
                            <div class="form-group">
                                <label for="doctor-specialty">Especialidade <span class="required">*</span></label>
                                ...
                                <div class="form-error" id="specialty-error">Por favor, selecione uma especialidade</div>
                            </div>

                            <div class="form-group">
                                <label for="doctor-license">Número da Licença <span class="required">*</span></label>
                                <input type="text" id="doctor-license" class="form-input" required placeholder="Número da licença médica">
                                <div class="form-hint">Número de registro no conselho médico</div>
                                <div class="form-error" id="license-error">Por favor, insira um número de licença válido</div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (!specialtyInput.value) {
                specialtyInput.classList.add('input-error');
        ...
        async function saveDoctor(event) {
            ...
            const especialidade = specialtyInput.value;
            const licenca = licenseInput.value.trim();
            ...
            const endpoint = isEditMode ? '<?= site_url('admin/update_doctor') ?>' : '<?= site_url('admin/create_doctor') ?>';
            ...
            try {
                ...
                if (!response.ok) {
                    showNotification(result.error || 'Erro ao salvar médico.', 'error');
                    return;
                }
                ...
                if (result.error) {
                    ...
                    showNotification(result.success || (isEditMode ? 'Médico atualizado com sucesso!' : 'Médico cadastrado com sucesso!'), 'success');
                    setTimeout(() => {
                        window.location.href = '<?= site_url('admin/medicos') ?>';
                    }, 1500);
                }
            } catch (error) {
        ...
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            const inputs = ['doctor-name', 'doctor-bi', 'doctor-email', 'doctor-license'];
            inputs.forEach(id => {
                ...
                if (input) {
                    ...
                    input.addEventListener('blur', function() {
                        if (this.value.trim() && this.id !== 'doctor-email') {
                            this.classList.add('input-success');
                        }
                    });
                }
            ...
            if (bi) {
                ...
                saveBtn.innerHTML = '<i class="fas fa-save mr-1"></i>Salvar';
            }
