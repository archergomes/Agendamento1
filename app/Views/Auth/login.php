...
<head>
    ...
    <title>Login | Centro de Saúde Da Matola II</title>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="msg-container">
                ...
                <div id="login-error" class="msg msg-error">
                    <i class="fas fa-exclamation-circle mr-1"></i>
                    <span id="error-text">Credenciais inválidas. Tente novamente.</span>
                </div>
                <div id="login-success" class="msg msg-success">
                    <i class="fas fa-check-circle mr-1"></i>
            ...
            <!-- Formulário -->
            <form action="<?= site_url('auth/login'); ?>" method="POST" id="login-form" class="space-y-4">
                <?= csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" id="email" name="email" value="<?= old('email'); ?>"
                            required autofocus placeholder="seu.email@dominio.com"
                            autocomplete="email">
                    </div>
                ...
                form.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        if (response.ok && result.status === 'success') {
                            ...
                            errorText.textContent = result.message || 'Credenciais inválidas. Tente novamente.';
                            errorMsg.style.display = 'block';
                            loginBtn.classList.remove('loading');
                            loginBtn.disabled = false;
                        }
