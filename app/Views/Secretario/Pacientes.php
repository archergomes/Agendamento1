...
<head>
    ...
    <title>Pacientes - Secretário - Centro de Saúde Da Matola II</title>
    <meta name="description" content="Gerenciar pacientes">
    ...
    <style>
        ...
        .form-input-modal {
            ...
            transition: border-color 0.2s; font-size: 0.85rem; background: white;
        }
...
<body>
    ...
    <div id="sidebar-menu" class="sidebar desktop">
        ...
        <nav class="sidebar-nav">
            <div class="main-menu">
                ...
                <a href="<?= site_url('secretario/pacientes') ?>" class="active">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="search-box">
                                ...
                                <input type="text" id="search-patient" class="form-input w-full" placeholder="Nome, BI ou telefone...">
                            </div>
                        </div>
    ...
    <script>
        ...
        async function loadPatients(page = 1) {
            ...
            try {
                let url = AJAX_URL + `/secretario/get_patients?page=${page}&limit=10`;
                ...
                list.innerHTML = data.data.map(patient => {
                    const statusClass = patient.Telefone ? 'ativo' : 'inativo';
                    const statusLabel = patient.Telefone ? 'Ativo' : 'Inativo';
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="flex justify-center gap-1">
                                    <button class="btn-sm btn-view" onclick="viewPatient('${patient.BI || ''}')" title="Ver detalhes">
        ...
        async function viewPatient(bi) {
            ...
            try {
                ...
                const response = await fetch(AJAX_URL + '/admin/get_patient_details', {
                    method: 'POST',
                ...
                const data = await response.json();
                console.log('Detalhes do paciente:', data);
                ...
                body.innerHTML = `
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-user mr-1"></i>Nome</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;">${data.name || 'N/A'}</span>
                    </div>
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-phone mr-1"></i>Telefone</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;">${data.phone || 'N/A'}</span>
                    </div>
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-id-card mr-1"></i>BI</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;font-family:monospace;">${data.bi || 'N/A'}</span>
                    </div>
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-envelope mr-1"></i>Email</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;">${data.email || 'N/A'}</span>
                    </div>
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-calendar-alt mr-1"></i>Data Nascimento</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;">${data.birthday || 'N/A'}</span>
                    </div>
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-venus-mars mr-1"></i>Género</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;">${data.gender || 'N/A'}</span>
                    </div>
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-map-marker-alt mr-1"></i>Endereço</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;">${data.address || 'N/A'}</span>
                    </div>
                    <div class="detail-row" style="display:flex;padding:0.6rem 0;border-bottom:1px solid #f3f4f6;">
                        <span class="detail-label" style="font-weight:600;color:#6b7280;width:35%;flex-shrink:0;"><i class="fas fa-calendar-plus mr-1"></i>Cadastrado em</span>
                        <span class="detail-value" style="color:#1f2937;width:65%;">${data.created_at || 'N/A'}</span>
                    </div>
                `;

            } catch (error) {
                console.error('Erro ao carregar detalhes:', error);
                body.innerHTML = `<div class="empty-state text-red-500">Erro ao carregar dados do paciente.</div>`;
            }
        }
